...
export const App: FC<PropsWithChildren<Props>> = () => {
  return (
    <div>
      <div className="bg-primary bg-opacity-10 h-screen w-[calc((100%-1024px)/2+320px)] fixed top-0 left-0 bottom-0 bg-[url('/src/large.png')] bg-center bg-cover -z-[1] grayscale  opacity-10 hidden md:block"></div>
